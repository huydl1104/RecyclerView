...
abstract class StickyNormalItemLine<VH:RecyclerView.ViewHolder> : RecyclerView.ItemDecoration {
   ...
   override fun getItemOffsets(
    ...
    private fun showHeaderAboveItem(itemAdapterPosition: Int): Boolean {
        return if (itemAdapterPosition == 0) { true
        } else getHeaderId(itemAdapterPosition - 1) != getHeaderId(itemAdapterPosition)
    }
    ...
    override fun onDrawOver(
        @NonNull canvas: Canvas, @NonNull parent: RecyclerView,
